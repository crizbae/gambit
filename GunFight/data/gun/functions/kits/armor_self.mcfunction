item replace entity @s[tag=Blue,gamemode=!creative,gamemode=!spectator] armor.head with marbledsarsenal:winter_military_armor_helmet
item replace entity @s[tag=Blue,gamemode=!creative,gamemode=!spectator] armor.chest with marbledsarsenal:winter_military_armor_chestplate
item replace entity @s[tag=Blue,gamemode=!creative,gamemode=!spectator] armor.legs with marbledsarsenal:winter_military_armor_leggings
item replace entity @s[tag=Blue,gamemode=!creative,gamemode=!spectator] armor.feet with marbledsarsenal:winter_military_armor_boots
item replace entity @s[tag=Red,gamemode=!creative,gamemode=!spectator] armor.head with marbledsarsenal:desert_military_armor_helmet
...
item replace entity @s[tag=Blue,gamemode=!creative,gamemode=!spectator] hotbar.8 with minecraft:blue_wool{display:{Name:'{"text":"Blue Team","color":"aqua","italic":false,"bold":true}'}}